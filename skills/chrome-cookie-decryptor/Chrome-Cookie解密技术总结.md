...
state = json.load(open(
    r"C:\Users\Administrator\AppData\Local\Google\Chrome\User Data\Local State",
    "r", encoding="utf-8"))
...
# 写结果到临时文件（跨进程传递）
result_file = r"C:\Users\Administrator\AppData\Local\Temp\chrome_v20_key.txt"
...
sc create ChromeDecrypt binPath= "C:\Users\Administrator\AppData\Local\Python\pythoncore-3.14-64\python.exe C:\Users\Administrator\Desktop\daliy\decrypt_as_system.py" type= own start= demand
...
| Cookie 名 | 域名 | 用途 | 示例值 |
|-----------|------|------|--------|
| SESSDATA | .bilibili.com | 登录 session | `4a7b3d09%2C1794905001%2C...` |
| bili_jct | .bilibili.com | CSRF token | `5a9ead20066d19921a795749183d72ad` |
| DedeUserID | .bilibili.com | 用户 ID | `179069592` |
| DedeUserID__ckMd5 | .bilibili.com | 用户 ID 校验 | `bb09a6447507f145` |
